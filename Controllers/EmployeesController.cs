...
namespace HRMS.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(ApplicationDbContext context, IWebHostEnvironment env, IHttpClientFactory httpClientFactory)
        {
            _context = context;
            _env = env;
      ...
      IFormFile file, string empCode, string name, string existing = null)
        ...
        public async Task<IActionResult> VerifyPan(string panNumber, string name, string dob)
        {
            try
            {
                ...
                client.DefaultRequestHeaders.Add("x-api-secret", "x-api-secret");
